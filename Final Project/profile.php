...
<div style="width: 800px; margin:auto;  min-height: 400px;">
	<div style="background-color: white; text-align: center; color: #405d9b;">
		...
		<br>
		<div style="font-size: 20px;">Miss BGC</div>		
		<br>
	...
	<div style="display: flex;">
		...
		<div style="min-height: 400px; flex: 1;">
			...
			<div id="friends_bar">
				...
				<div id="friends">
					<img src="user1.jpg" id="friends_img"><br>
					Mynul Alam
				</div>
				<div id="friends">
					<img src="user2.jpg" id="friends_img"><br>
					Ramim Hossain
				</div>
				<div id="friends">
					<img src="user3.jpg" id="friends_img"><br>
					Ala Uddin
				</div>
				<div id="friends">
					<img src="user4.jpg" id="friends_img"><br>
					BGC Gril
				</div>
